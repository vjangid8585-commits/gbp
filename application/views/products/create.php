...
<head>
    ...
    <title>Add Product - <?php echo $location->business_name; ?> - GBP Agency</title>
...
<body>
    ...
    <div class="container-main">
        <div class="mb-5">
            <h1 class="page-title"><i class="bi bi-plus-circle me-2"></i>Add Product</h1>
        ...
        <div class="glass-card">
            <?php echo form_open_multipart('products/store/'.$location->id); ?>
                <div class="mb-4">
