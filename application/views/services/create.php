...
<head>
    ...
    <title>Add Service - <?php echo $location->business_name; ?> - GBP Agency</title>
...
<body>
    ...
    <div class="container-main">
        <div class="mb-5">
            <h1 class="page-title"><i class="bi bi-plus-circle me-2"></i>Add Service</h1>
        ...
        <div class="glass-card">
            <?php echo form_open('services/store/'.$location->id); ?>
                <div class="mb-4">
                    ...
                    <input type="text" name="name" class="form-control form-control-glass" 
                           placeholder="e.g., Hair Cut, Oil Change, Consultation" required>
                </div>
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="category" class="form-control form-control-glass" 
                               placeholder="e.g., Haircare, Repair">
                    </div>
                </div>

                <div class="d-flex gap-3">
                    <button type="submit" class="btn btn-primary-glow">
                        <i class="bi bi-check-lg me-2"></i> Add Service
                    </button>
